...
class BackyardPolygon(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.post('https://protected-peak-85531.herokuapp.com/get_backyard_polygon', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            return JsonResponse(all_data)
        else:
...
class HazardAnalysis(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.get('https://protected-peak-85531.herokuapp.com/get_all_hazard_info', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            return JsonResponse(all_data)
        else:
...
class FrontStreet(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.post('https://protected-peak-85531.herokuapp.com/get_front_street', params={'address':address})
        data = {}
        if r.status_code == 200:
            all_data = r.json()
...
class IsAtCulDeSac(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.get('https://protected-peak-85531.herokuapp.com/is_at_cul_de_sac', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            # print(all_data)
...
class BackStreetOrAlleyPresent(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.get('https://protected-peak-85531.herokuapp.com/back_road_or_alley_present', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            return Response(all_data)
        else:
...
class IsCornerLot(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.get('https://protected-peak-85531.herokuapp.com/is_corner_lot', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            return Response(all_data)
        else:
...
class IsReversedCornerLot(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.get('https://protected-peak-85531.herokuapp.com/is_reversed_corner_lot', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            return Response(all_data)
        else:
...
class ParcelSides(APIView):
    ...
    def get(self, request, address_slug):
        address = address_slug.replace("+", " ")
        r = requests.post('https://protected-peak-85531.herokuapp.com/get_all_color_coded_sides', params={'address':address})
        if r.status_code == 200:
            all_data = r.json()
            return Response(all_data)
        else:
